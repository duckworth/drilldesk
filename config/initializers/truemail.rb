Truemail.configure do |config|
  ...
  config.verifier_email = Mail::Address.new(Rails.application.config.app_settings.mailer_sender).address
  ...
  config.validation_type_for = { "drilldesk.com" => :regex,
                                 "graavy.com" => :regex,
                                 "gmail.com" => :regex }
  ...
  config.blacklisted_domains = [ "blocklisted-test.com" ]
