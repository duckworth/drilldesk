ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "DrillDesk Admin"
  ...
  config.authorization_adapter = "CustomAdminAuthorization"
  ...
  config.namespace :admin do |admin|
    admin.build_menu :default do |menu|
      menu.add label: "Feature Flags", url: "/admin/feature-flags", if: proc { current_user.sys_admin? }
    end
  end

  ActiveAdmin.before_load do
    ActiveAdmin::BaseController.include ActiveAdminActions
  end
end
